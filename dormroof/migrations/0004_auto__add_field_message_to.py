...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.to'
        db.add_column('dormroof_message', 'to',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dormroof.UserProfile'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.to'
        db.delete_column('dormroof_message', 'to_id')
